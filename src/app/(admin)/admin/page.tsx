...
const Dashboard = () => {
  ...
  const enrollmentData = [
    { name: 'Tháng 1', enrollments: 65 },
    { name: 'Tháng 2', enrollments: 78 },
    { name: 'Tháng 3', enrollments: 90 },
    { name: 'Tháng 4', enrollments: 85 },
    { name: 'Tháng 5', enrollments: 99 },
    { name: 'Tháng 6', enrollments: 105 },
  ];
