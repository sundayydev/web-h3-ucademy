...
const PaymentsPage = () => {
  ...
  const isThisWeek = (date: number | string) => {
    const today = new Date();
    const orderDate = new Date(date);
  ...
  const isThisMonth = (date: number | string) => {
    const today = new Date();
    const orderDate = new Date(date);
    return (
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-[10%] text-pink-500">
                  Phương thức
                </TableHead>
                <TableHead className="w-[15%] text-pink-500">
                  Trạng thái
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                {selectedOrder.courseName || selectedOrder.courseId}
              </p>
              <p>
