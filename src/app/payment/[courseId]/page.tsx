...
const PaymentModal = () => {
  ...
  const handlePayment = async () => {
    ...
    const orderData: CreateOrderDto = {
      userId,
      amount: total,
      orderDetails: [{ courseId: course.id, price: total }],
    };
    ...
    try {
      ...
      if (paymentResponse.isFree) {
        ...
        router.push(`/payment-success/${paymentResponse.orderId}`);
      ...
      setErrorMessage(`Thanh toán thất bại: ${error.message}`);
        ...
        {course && (
          <div className="md:w-1/2 p-4">
            <div className="flex items-center space-x-3">
              <img
                src={course.urlImage ? `${process.env.NEXT_PUBLIC_API_URL}/${course.urlImage}` : 'https://via.placeholder.com/50'}
                alt={course.title}
