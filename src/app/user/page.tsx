        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center py-10">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-xl font-semibold">{user.fullName || 'Người dùng'}</h1>
                        <p className="text-gray-600">{user.email || 'lehoaihuan@gmail.com'}</p>
                ...
                <div className="space-y-2">
                    ...
                    <p>
                        ...
                        {user.birthDate ? new Date(user.birthDate).toLocaleDateString('vi-VN') : 'Chưa cung cấp'}
                    </p>
                    <p>
                    ...
                    <p><strong>Địa chỉ IP:</strong> {user.ipAddress || 'Chưa cung cấp'}</p>
                    <p><strong>Tên thiết bị:</strong> {user.deviceName || 'Chưa cung cấp'}</p>
                    <p><strong>Google ID:</strong> {user.googleId || 'Chưa liên kết'}</p>
                    <p>
