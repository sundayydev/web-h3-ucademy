      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 max-w-md text-center">
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          <p className="text-gray-700 font-medium">
            Mã đơn hàng: <span className="font-semibold text-gray-900">{id}</span>
          </p>
          {amount && (
            <p className="text-gray-700">
              Số tiền: <span className="font-semibold text-green-600">{parseInt(amount) / 100} VND</span>
            </p>
          )}
          {orderInfo && (
            <p className="text-gray-700">
              <span className="font-semibold text-gray-900">{orderInfo}</span>
            </p>
          )}
        </div>
        <button
